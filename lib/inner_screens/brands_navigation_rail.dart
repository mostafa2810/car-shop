                ...
                child: ConstrainedBox(
                  ...
                  child: IntrinsicHeight(
                    child: NavigationRail(
                      ...
                      destinations: [
                        buildRotatedTextRailDestination('BMW', padding),
                        buildRotatedTextRailDestination("Volkswagen", padding),
                        buildRotatedTextRailDestination("Mercedis-Benz", padding),
                        buildRotatedTextRailDestination("HYUNDAI", padding),
                        buildRotatedTextRailDestination("Audi", padding),
                        buildRotatedTextRailDestination("NISSAN", padding),
                        buildRotatedTextRailDestination("PROTON", padding),
