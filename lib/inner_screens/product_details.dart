...
import 'package:car_zone/consts/my_icons.dart';
import 'package:car_zone/provider/cart_provider.dart';
import 'package:car_zone/provider/dark_theme_provider.dart';
import 'package:car_zone/provider/products.dart';
import 'package:car_zone/screens/cart.dart';
import 'package:car_zone/screens/wishlist.dart';
import 'package:car_zone/widget/feeds_products.dart';
import 'package:car_zone/widget/popular_products.dart';
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: RaisedButton(
                      ...
                      color: Color.fromARGB(255, 23, 189, 255),
                      onPressed:
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: RaisedButton(
                      materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
                      shape: RoundedRectangleBorder(side: BorderSide.none),
                      color:Color.fromARGB(255, 22, 45, 77),
                      onPressed: () {},
                      child: Row(
                        children: [
                          Text(
